...
export const WEAPONS = {
  // ---- Terran ----
  terranTurret: { name: 'Terran turret', type: 'turret', damage: 10, range: 850, delay: 8500, speed: 420, bolt: 'fx_bolt_subach' },
  terranHuge:   { name: 'Heavy laser turret', type: 'turret', damage: 22, range: 1300, delay: 14000, speed: 280, bolt: 'fx_bolt_terranhuge' },
  fusionMortar: { name: 'Fusion mortar', type: 'turret', damage: 30, range: 1100, delay: 9000, speed: 250, bolt: 'fx_bolt_terranhuge' },
  standardFlak: { name: 'Standard flak', type: 'turret', damage: 5, range: 650, delay: 1600, speed: 380, bolt: 'fx_bolt_subach', burst: true, anti: true },
  longFlak:     { name: 'Long-range flak', type: 'turret', damage: 6, range: 900, delay: 2200, speed: 400, bolt: 'fx_bolt_subach', burst: true, anti: true },
  heavyFlak:    { name: 'Heavy flak', type: 'turret', damage: 9, range: 800, delay: 2800, speed: 380, bolt: 'fx_bolt_subach', burst: true, anti: true },
  fighterKiller:{ name: 'Fighter-killer missiles', type: 'turret', damage: 20, range: 950, delay: 9000, speed: 300, bolt: 'fx_bolt_terranweak', anti: true },
  aaaf:         { name: 'AAAf beam', type: 'turret', damage: 36, range: 950, delay: 7000, speed: 0, beam: true, anti: true, chargeMs: 600, holdMs: 1000, beamTex: 'fx_beam_aaa', beamWidth: 14 },
  terslash:     { name: 'TerSlash beam', type: 'turret', damage: 130, range: 1600, delay: 14000, speed: 0, beam: true, slash: true, chargeMs: 1400, holdMs: 2000, beamTex: 'fx_beam_terslash', beamWidth: 20 },
  lterslash:    { name: 'LTerSlash beam', type: 'spinal', damage: 80, range: 1600, delay: 12000, speed: 0, beam: true, slash: true, chargeMs: 1200, holdMs: 1800, beamTex: 'fx_beam_lterslash', beamWidth: 16 },
  sgreen:       { name: 'SGreen beam', type: 'spinal', damage: 110, range: 1600, delay: 30000, speed: 0, beam: true, chargeMs: 1800, holdMs: 2500, beamTex: 'fx_beam_sgreen', beamWidth: 18 },
  bgreen:       { name: 'BGreen beam', type: 'spinal', damage: 320, range: 1600, delay: 30000, speed: 0, beam: true, holdMs: 4000, beamTex: 'fx_beam_bgreen', beamWidth: 24 },
  bfgreen:      { name: 'BFGreen beam', type: 'spinal', damage: 480, range: 1700, delay: 35000, speed: 0, beam: true, holdMs: 4000, beamTex: 'fx_beam_bfgreen', beamWidth: 30 },
  // ---- Vasudan ----
  vasudanTurret:{ name: 'Vasudan turret', type: 'turret', damage: 10, range: 850, delay: 8500, speed: 420, bolt: 'fx_bolt_vasudan' },
  svas:         { name: 'SVas beam', type: 'turret', damage: 170, range: 1600, delay: 20000, speed: 0, beam: true, chargeMs: 1400, holdMs: 2500, beamTex: 'fx_beam_svas', beamWidth: 20 },
  vslash:       { name: 'VSlash beam', type: 'turret', damage: 125, range: 1600, delay: 14000, speed: 0, beam: true, slash: true, chargeMs: 1400, holdMs: 2000, beamTex: 'fx_beam_vslash', beamWidth: 20 },
  bvas:         { name: 'BVas beam', type: 'spinal', damage: 310, range: 1600, delay: 24000, speed: 0, beam: true, holdMs: 3700, beamTex: 'fx_beam_bvas', beamWidth: 24 },
  // ---- Shivan ----
  shivanTurret: { name: 'Shivan turret laser', type: 'turret', damage: 12, range: 800, delay: 8000, speed: 430, bolt: 'fx_bolt_shivan' },
  shivanHeavy:  { name: 'Shivan heavy laser', type: 'turret', damage: 20, range: 1000, delay: 12000, speed: 350, bolt: 'fx_bolt_shivanheavy' },
  shivanFlak:   { name: 'Shivan flak', type: 'turret', damage: 5, range: 650, delay: 1500, speed: 380, bolt: 'fx_bolt_shivan', burst: true, anti: true },
  shivanCluster:{ name: 'Shivan cluster missiles', type: 'turret', damage: 18, range: 900, delay: 8000, speed: 300, bolt: 'fx_bolt_shivanweak', anti: true },
  saaa:         { name: 'SAAA beam', type: 'turret', damage: 34, range: 950, delay: 7000, speed: 0, beam: true, anti: true, chargeMs: 600, holdMs: 1200, beamTex: 'fx_beam_saaa', beamWidth: 14 },
  sred:         { name: 'SRed beam', type: 'spinal', damage: 150, range: 1600, delay: 25000, speed: 0, beam: true, holdMs: 3800, beamTex: 'fx_beam_sred', beamWidth: 22 },
  lred:         { name: 'LRed beam', type: 'spinal', damage: 320, range: 1600, delay: 22000, speed: 0, beam: true, holdMs: 6000, beamTex: 'fx_beam_lred', beamWidth: 28 },
  bfred:        { name: 'BFRed beam', type: 'spinal', damage: 620, range: 2200, delay: 30000, speed: 0, beam: true, holdMs: 6000, beamTex: 'fx_beam_bfred', beamWidth: 32 },
  superlaser:   { name: 'Shivan super laser', type: 'spinal', damage: 480, range: 1900, delay: 32000, speed: 0, beam: true, holdMs: 5000, beamTex: 'fx_beam_superlaser', beamWidth: 30 },
};
...
export const CIVILIANS = {
  ...
  dis:         { name: 'SFr Dis', cls: 'Freighter', faction: 'Shivan', length: 90,
    url: 'ships/shivan/dis.png', flip: true, hull: 150, speed: 16, turn: 12, accel: 8, hardpoints: [],
