...
export const WEAPONS = {
  // Terran
  terranTurret: { name: 'Terran turret', type: 'turret', damage: 9, range: 850, delay: 4800, speed: 420, bolt: 'fx_bolt_subach' },
  terranHuge:   { name: 'Terran huge turret', type: 'spinal', damage: 50, range: 1100, delay: 9000, speed: 500, bolt: 'fx_bolt_terranhuge' },
  standardFlak: { name: 'Standard flak', type: 'turret', damage: 4, range: 500, delay: 1300, speed: 380, bolt: 'fx_bolt_subach', burst: true, anti: true },
  longFlak:     { name: 'Long-range flak', type: 'turret', damage: 5, range: 720, delay: 1600, speed: 400, bolt: 'fx_bolt_subach', burst: true, anti: true },
  aaaf:         { name: 'AAAf beam', type: 'turret', damage: 35, range: 900, delay: 8000, speed: 0, beam: true, anti: true, chargeMs: 250, holdMs: 700, beamTex: 'fx_beam_aaa', beamWidth: 14 },
  lterslash:    { name: 'LTerSlash beam', type: 'turret', damage: 110, range: 1200, delay: 15000, speed: 0, beam: true, slash: true, chargeMs: 450, holdMs: 2200, beamTex: 'fx_beam_lterslash', beamWidth: 18 },
  bgreen:       { name: 'BGreen beam', type: 'spinal', damage: 260, range: 1600, delay: 18000, speed: 0, beam: true, beamTex: 'fx_beam_bgreen', beamWidth: 24 },
  bfgreen:      { name: 'BFGreen beam', type: 'spinal', damage: 420, range: 1800, delay: 22000, speed: 0, beam: true, beamTex: 'fx_beam_bfgreen', beamWidth: 30 },
  // Vasudan
  vasudanTurret:{ name: 'Vasudan turret', type: 'turret', damage: 9, range: 850, delay: 4800, speed: 420, bolt: 'fx_bolt_vasudan' },
  svas:         { name: 'SVas slash beam', type: 'turret', damage: 85, range: 1100, delay: 13000, speed: 0, beam: true, slash: true, chargeMs: 450, holdMs: 2000, beamTex: 'fx_beam_svas', beamWidth: 20 },
  bvas:         { name: 'BVas beam', type: 'spinal', damage: 240, range: 1500, delay: 17000, speed: 0, beam: true, beamTex: 'fx_beam_bvas', beamWidth: 24 },
  // Shivan
  shivanTurret: { name: 'Shivan turret', type: 'turret', damage: 10, range: 850, delay: 4600, speed: 430, bolt: 'fx_bolt_shivan' },
  shivanFlak:   { name: 'Shivan flak', type: 'turret', damage: 4, range: 500, delay: 1250, speed: 380, bolt: 'fx_bolt_shivan', burst: true, anti: true },
  saaa:         { name: 'SAAA beam', type: 'turret', damage: 40, range: 900, delay: 8000, speed: 0, beam: true, anti: true, chargeMs: 250, holdMs: 700, beamTex: 'fx_beam_saaa', beamWidth: 14 },
  sred:         { name: 'SRed beam', type: 'spinal', damage: 230, range: 1500, delay: 17000, speed: 0, beam: true, beamTex: 'fx_beam_sred', beamWidth: 22 },
  lred:         { name: 'LRed beam', type: 'spinal', damage: 350, range: 1700, delay: 20000, speed: 0, beam: true, beamTex: 'fx_beam_lred', beamWidth: 28 },
  bfred:        { name: 'BFRed beam', type: 'spinal', damage: 520, range: 1900, delay: 24000, speed: 0, beam: true, beamTex: 'fx_beam_bfred', beamWidth: 32 },
};
...
export const STRIKECRAFT = {
  ...
  myrmidon:  { name: 'GTF Myrmidon', cls: 'Fighter', faction: 'GTVA', length: 15, url: 'ships/terran/myrmidon.png',
    speed: 185, turn: 160, hull: 16, gun: { damage: 4, range: 400, delay: 1000, speed: 560, bolt: 'fx_bolt_subach' } },
  perseus:   { name: 'GTF Perseus', cls: 'Interceptor', faction: 'GTVA', length: 17, url: 'ships/terran/perseus.png',
    speed: 205, turn: 150, hull: 14, gun: { damage: 4, range: 420, delay: 1300, speed: 580, bolt: 'fx_bolt_subach' } },
  hercules2: { name: 'GTF Hercules Mk II', cls: 'Assault fighter', faction: 'GTVA', length: 20, url: 'ships/terran/hercules2.png',
    speed: 160, turn: 120, hull: 26, gun: { damage: 6, range: 400, delay: 1150, speed: 540, bolt: 'fx_bolt_subach' } },
  ulysses:   { name: 'GTF Ulysses', cls: 'Fighter', faction: 'GTVA', length: 16, url: 'ships/terran/ulysses.png',
    speed: 190, turn: 175, hull: 15, gun: { damage: 4, range: 380, delay: 1300, speed: 560, bolt: 'fx_bolt_subach' } },
  medusa:    { name: 'GTB Medusa', cls: 'Bomber', faction: 'GTVA', length: 24, url: 'ships/terran/medusa.png',
    speed: 130, turn: 90, hull: 30, gun: { damage: 4, range: 350, delay: 1200, speed: 520, bolt: 'fx_bolt_subach' },
    bomb: { damage: 60, range: 780, delay: 11000, speed: 250, bolt: 'fx_bolt_terranhuge' } },
  ursa:      { name: 'GTB Ursa', cls: 'Heavy bomber', faction: 'GTVA', length: 31, url: 'ships/terran/ursa.png',
    speed: 110, turn: 70, hull: 45, gun: { damage: 5, range: 350, delay: 1300, speed: 520, bolt: 'fx_bolt_subach' },
    bomb: { damage: 90, range: 820, delay: 14000, speed: 230, bolt: 'fx_bolt_terranhuge' } },
  artemis:   { name: 'GTB Artemis', cls: 'Bomber', faction: 'GTVA', length: 24, url: 'ships/terran/artemis.png',
    speed: 150, turn: 100, hull: 26, gun: { damage: 4, range: 360, delay: 1150, speed: 530, bolt: 'fx_bolt_subach' },
    bomb: { damage: 55, range: 760, delay: 10000, speed: 260, bolt: 'fx_bolt_terranhuge' } },
  boanerges: { name: 'GTB Boanerges', cls: 'Heavy bomber', faction: 'GTVA', length: 30, url: 'ships/terran/boanerges.png',
    speed: 125, turn: 80, hull: 38, gun: { damage: 4, range: 350, delay: 1200, speed: 520, bolt: 'fx_bolt_subach' },
    bomb: { damage: 80, range: 800, delay: 13000, speed: 240, bolt: 'fx_bolt_terranhuge' } },
  // Vasudan
  serapis:   { name: 'GVF Serapis', cls: 'Interceptor', faction: 'Vasudan (allied)', length: 15, url: 'ships/vasudan/serapis.png',
    speed: 200, turn: 170, hull: 13, gun: { damage: 4, range: 410, delay: 1300, speed: 570, bolt: 'fx_bolt_mekhu' } },
  horus:     { name: 'GVF Horus', cls: 'Fighter', faction: 'Vasudan (allied)', length: 14, url: 'ships/vasudan/horus.png',
    speed: 195, turn: 180, hull: 12, gun: { damage: 3, range: 380, delay: 1200, speed: 560, bolt: 'fx_bolt_mekhu' } },
  tauret:    { name: 'GVF Tauret', cls: 'Fighter', faction: 'Vasudan (allied)', length: 21, url: 'ships/vasudan/tauret.png',
    speed: 170, turn: 140, hull: 22, gun: { damage: 5, range: 400, delay: 1100, speed: 550, bolt: 'fx_bolt_mekhu' } },
  sekhmet:   { name: 'GVB Sekhmet', cls: 'Bomber', faction: 'Vasudan (allied)', length: 29, url: 'ships/vasudan/sekhmet.png',
    speed: 140, turn: 95, hull: 34, gun: { damage: 4, range: 360, delay: 1150, speed: 530, bolt: 'fx_bolt_mekhu' },
    bomb: { damage: 75, range: 800, delay: 12000, speed: 245, bolt: 'fx_bolt_vasudan' } },
  osiris:    { name: 'GVB Osiris', cls: 'Bomber', faction: 'Vasudan (allied)', length: 30, url: 'ships/vasudan/osiris.png',
    speed: 120, turn: 85, hull: 30, gun: { damage: 3, range: 340, delay: 1200, speed: 510, bolt: 'fx_bolt_mekhu' },
    bomb: { damage: 60, range: 760, delay: 11000, speed: 240, bolt: 'fx_bolt_vasudan' } },
  bakha:     { name: 'GVB Bakha', cls: 'Bomber', faction: 'Vasudan (allied)', length: 24, url: 'ships/vasudan/bakha.png',
    speed: 145, turn: 100, hull: 28, gun: { damage: 4, range: 360, delay: 1150, speed: 530, bolt: 'fx_bolt_mekhu' },
    bomb: { damage: 60, range: 780, delay: 10500, speed: 255, bolt: 'fx_bolt_vasudan' } },
  // Shivan
  mara:      { name: 'SF Mara', cls: 'Fighter', faction: 'Shivan', length: 17, url: 'ships/shivan/mara.png',
    speed: 195, turn: 165, hull: 15, gun: { damage: 4, range: 400, delay: 1300, speed: 570, bolt: 'fx_bolt_shivanlight' } },
  manticore: { name: 'SF Manticore', cls: 'Interceptor', faction: 'Shivan', length: 16, url: 'ships/shivan/manticore.png',
    speed: 210, turn: 155, hull: 12, gun: { damage: 3, range: 390, delay: 1200, speed: 580, bolt: 'fx_bolt_shivanlight' } },
  basilisk:  { name: 'SF Basilisk', cls: 'Assault fighter', faction: 'Shivan', length: 32, url: 'ships/shivan/basilisk.png',
    speed: 155, turn: 115, hull: 28, gun: { damage: 6, range: 410, delay: 1150, speed: 550, bolt: 'fx_bolt_shivanlight' } },
  dragon:    { name: 'SF Dragon', cls: 'Fighter', faction: 'Shivan', length: 18, url: 'ships/shivan/dragon.png',
    speed: 220, turn: 190, hull: 14, gun: { damage: 4, range: 400, delay: 1200, speed: 580, bolt: 'fx_bolt_shivanlight' } },
  aeshma:    { name: 'SF Aeshma', cls: 'Assault fighter', faction: 'Shivan', length: 26, url: 'ships/shivan/aeshma.png',
    speed: 165, turn: 125, hull: 24, gun: { damage: 5, range: 400, delay: 1100, speed: 550, bolt: 'fx_bolt_shivanlight' } },
  seraphim:  { name: 'SB Seraphim', cls: 'Heavy bomber', faction: 'Shivan', length: 42, url: 'ships/shivan/seraphim.png',
    speed: 125, turn: 80, hull: 40, gun: { damage: 4, range: 350, delay: 1200, speed: 520, bolt: 'fx_bolt_shivanlight' },
    bomb: { damage: 80, range: 800, delay: 13000, speed: 240, bolt: 'fx_bolt_shivanheavy' } },
  nephilim:  { name: 'SB Nephilim', cls: 'Bomber', faction: 'Shivan', length: 40, url: 'ships/shivan/nephilim.png',
    speed: 130, turn: 85, hull: 36, gun: { damage: 4, range: 350, delay: 1200, speed: 520, bolt: 'fx_bolt_shivanlight' },
    bomb: { damage: 70, range: 780, delay: 11000, speed: 245, bolt: 'fx_bolt_shivanheavy' } },
  taurvi:    { name: 'SB Taurvi', cls: 'Bomber', faction: 'Shivan', length: 33, url: 'ships/shivan/taurvi.png',
    speed: 140, turn: 95, hull: 30, gun: { damage: 4, range: 360, delay: 1150, speed: 530, bolt: 'fx_bolt_shivanlight' },
    bomb: { damage: 60, range: 770, delay: 10500, speed: 250, bolt: 'fx_bolt_shivanheavy' } },
  nahema:    { name: 'SB Nahema', cls: 'Bomber', faction: 'Shivan', length: 30, url: 'ships/shivan/nahema.png',
    speed: 150, turn: 100, hull: 28, gun: { damage: 4, range: 360, delay: 1150, speed: 530, bolt: 'fx_bolt_shivanlight' },
    bomb: { damage: 65, range: 780, delay: 10500, speed: 255, bolt: 'fx_bolt_shivanheavy' } },
};
